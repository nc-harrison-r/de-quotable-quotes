from src.helpers_task_1 import get_parameter
...
def write_file_to_s3(path_to_file: str, bucket_name: str, object_key: str, **kwargs):
    ...
    Args:
      path_to_file: a local file path, either absolute or relative to the root of this repository.
...
if __name__ == "__main__":
    msg = write_file_to_s3("tests/sonnet18.txt", S3_BUCKET_NAME, "sonnets/sonnet18.txt")
    print(msg)
